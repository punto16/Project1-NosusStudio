#ifndef __MODULE_PLAYGROUND2_H__
#define __MODULE_PLAYGROUND2_H__
...
class ModulePlayGround2 : public Module
{
public:
    // Constructor
    ModulePlayGround2(bool startEnabled);
    ...
    void NextBlock();
    int RandomBlock();
    void LoadBlockMatrix(Block2& block);
    bool IsColliding(int x2, int y2, Block2& block);
...
public:
    ...
    Block2 block, nextBlock, blockCheck;
...
#endif //!__MODULE_PLAYGROUND2_H__